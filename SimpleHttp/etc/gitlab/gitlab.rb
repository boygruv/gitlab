...
external_url 'https://gitlab.boygruv.lc'
...
registry_external_url 'http://registry.gitlab.boygruv.lc'

### Settings used by GitLab application
gitlab_rails['registry_enabled'] = true
gitlab_rails['registry_host'] = "registry.gitlab.boygruv.lc"
...
#gitlab_rails['registry_key_path'] = "/etc/gitlab/ssl/registry.gitlab.boygruv.lc.key"
...
#registry['rootcertbundle'] = "/etc/gitlab/ssl/rootCA.crt"
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/gitlab.boygruv.lc.crt"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/gitlab.boygruv.lc.key"
